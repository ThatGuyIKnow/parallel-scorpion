#ifndef HTREE_PACKED_STATE_REGISTRY_H
#define HTREE_PACKED_STATE_REGISTRY_H
...
class HTreePackedStateRegistry :
...
public:
    explicit HTreePackedStateRegistry(const TaskProxy &task_proxy);
    ...
    */
    ...
    class const_iterator {
        ...
        friend class HTreePackedStateRegistry;
        const HTreePackedStateRegistry &registry;
        StateID pos;

        const_iterator(const HTreePackedStateRegistry &registry, size_t start)
...
public:
    ...
    class iterator_impl : public IStateRegistry::const_iterator {
        const HTreePackedStateRegistry *registry_;
        size_t idx_;
    public:
        iterator_impl(const HTreePackedStateRegistry *reg, size_t i) : registry_(reg), idx_(i) {}
