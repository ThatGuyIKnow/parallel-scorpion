#ifndef HTREE_UNPACKED_STATE_REGISTRY_H
#define HTREE_UNPACKED_STATE_REGISTRY_H
...
class HTreeUnpackedStateRegistry :
...
public:
    explicit HTreeUnpackedStateRegistry(const TaskProxy &task_proxy);
    ...
    */
    ...
    class const_iterator {
        ...
        friend class HTreeUnpackedStateRegistry;
        const HTreeUnpackedStateRegistry &registry;
        StateID pos;

        const_iterator(const HTreeUnpackedStateRegistry &registry, size_t start)
...
public:
    ...
    class iterator_impl : public IStateRegistry::const_iterator {
        const HTreeUnpackedStateRegistry *registry_;
        size_t idx_;
    public:
        iterator_impl(const HTreeUnpackedStateRegistry *reg, size_t i) : registry_(reg), idx_(i) {}
