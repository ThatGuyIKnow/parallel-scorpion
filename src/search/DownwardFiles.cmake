...
fast_downward_plugin(
    NAME OPEN_STATE_REGISTRY
    HELP "State registries that can unregister states, used for storing only open states."
    SOURCES
        open_state_registry
    DEPENDENCY_ONLY
)
...
fast_downward_plugin(
    ...
    SOURCES
        closed_list
        closed_lists/bdd_closed_list
        closed_lists/loes_closed_list
    DEPENDS LOES
)

fast_downward_plugin(
    NAME LOES
    HELP "LOES data structure"
    SOURCES
        loes/cloes
        loes/loes
        loes/merge_container
        loes/bitstate
    DEPENDS DYNAMIC_BITSET
)
...
fast_downward_plugin(
    NAME POPCOUNT
    HELP "Popcount library from https://github.com/kimwalisch/libpopcnt"
    SOURCES
        algorithms/libpopcnt
    DEPENDENCY_ONLY
)
...
fast_downward_plugin(
    NAME ASTARMOD_SEARCH
    HELP "A* search algorithm"
    SOURCES
        search_engines/astar_search
    DEPENDS SEARCH_COMMON OPEN_STATE_REGISTRY
)
