...
pairs = [
    ("-no-closed-blind", "-loes-blind"),
    ("-no-closed-blind", "-cloes-blind"),
    ("-no-closed-blind", "-bdd-blind"),
]
    ...
    for form in ["tex", "png"]:
        exp.add_report(
            project.ScatterPlotReport(
                ...
                filter=[project.add_proportion_closed, project.add_evaluations_per_time, attr_comparison_filter("-cloes-blind", "-bdd-blind", attr1, attr2)],
