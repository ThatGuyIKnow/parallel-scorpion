...
def build_exp(additional_options=[], nick=None): # this is for running seperate experiments with both pruning and no
    ...
    exp.add_step("dep", subprocess.call, ["cmake", "-S", "dependencies", "-B", "dependencies/build", "-DCMAKE_INSTALL_PREFIX=dependencies/installs", "-DCMAKE_PREFIX_PATH=$PWD/dependencies/installs",
